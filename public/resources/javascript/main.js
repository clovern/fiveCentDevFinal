...
addProject("./resources/javascript/jImages/songClassification.png", "Lyrics -> Song Genre Machine Learning Classifier", "December 2024", "Jupyter Notebook, Python", "Natural Language Processing, Random Forests, L-GBM", "This natural language processing project investigates how accurately songs can be classified into genres based on lyrics alone.", "https://nbviewer.org/github/clovern/Song-classification-Natural-Language-Processing/blob/main/FinalProject_12_6_edited.ipynb");
addProject("./resources/javascript/jImages/steppingStones.png", "Stepping Stone Network", "November 2024", "Python: multithreaded sockets", "", "Creates a working stepping stone network, which uses a pathway of computers to hide the true identity (IP address) of a device.", "./steppingStone.html");
addProject("./resources/javascript/jImages/MyMealsPreview.png", "Meal Plan & Grocery List Creator App", "April 2024", "Python, Tkinter", "", "Generates a meal plan based on your preferences, and creates a grocery list for that meal plan.", "./myMeals.html");
addProject("./resources/javascript/jImages/articleSummarizer.png", "Wikipedia Article Summarizer", "October 2024", "Hadoop MapReduce (Java)", "", "Summarizes 1Gb of Wikipedia articles down to their 5 most relevant sentences (based on a TF-IDF weighting system)", "./articleSummarizer.html");
addProject("./resources/javascript/jImages/pageRank.png", "Mini Search Engine", "November 2024", "Apache Spark (Java)", "", "Displays the most relevant wikipedia articles for a given search term, using Google's page rank algorithm", "./miniSearchEngine.html");
